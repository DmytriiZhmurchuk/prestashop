		...
		<div class="col-lg-6">
			<div class="panel clearfix">
				...
				<div class="form-horizontal">
					...
					<div class="row">
						<label class="control-label col-lg-3">{l s='Mobile phone'}</label>
						<div class="col-lg-9">
							<p class="form-control-static">{if $customer->phone_mobile}{$customer->phone_mobile}{else}{l s='Unknown'}{/if}</p>
						</div>
					</div>
					<div class="row">
