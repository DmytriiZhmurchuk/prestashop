...
class OrderController extends OrderControllerCore
{
    ...
    public function init()
    {
        ...
        if ($this->context->customer->id) {
            $this->context->smarty->assign('cs_firstname',$this->context->customer->firstname);
            $this->context->smarty->assign('cs_lastname',$this->context->customer->lastname);
            $this->context->smarty->assign('cs_phone_mobile',$this->context->customer->phone_mobile);
            $this->context->smarty->assign('cs_email',$this->context->customer->email);
        } else {
   ...
   protected function parentProcessCarrier()
    {
        echo("start process");
